...
public class Reference {
	...
	public static final String MODID = "argon";
	public static final String NAME = "Esrome's Science Mod";
	public static final String VERSION = "1.0.0";
	public static final String COMPATIBLE_VERSIONS = "[1.12.2]";
	...
	public static final int GUI_BELT_GRINDER = 4;
	public static final int GUI_FABRICATOR = 5;
